...
const config = {
  ...
  corsOptions: {
    ...
    origin: [
      ...
      'http://localhost:8001',
      'http://driftconditions:80',
      'https://driftconditions:443',
      'https://driftconditions:8080',
      'http://driftconditions:8081',
      'https://driftconditions:8082',
      'http://driftconditions:8083',
      'https://driftconditions:8000',
      'http://driftconditions:8001',      
    ],
    credentials: true,
  },  
  mixEngineServer: {
  ...
  mixes: {
    ...
    maxQueued: 12,
    checkTime: 1000 * 60 * 2, // 2 minutes
    playlistPeriod: 1000 * 60 * 60 * 6, // 6 hours
  },
  bcrypt: {
    saltRounds: 10,
  },
